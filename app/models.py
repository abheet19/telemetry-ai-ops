...
class TelemetryRecord(BaseModel):
    ...
    wavelength:float =Field(...,gt=1500,lt=1600,description="Optical Wavelength in nm")
    osnr:float =Field(...,gt=0,lt=40,description="Optical Signal to Noise Ratio in dB")
