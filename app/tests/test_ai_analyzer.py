...
@pytest.mark.parametrize("data,expected_keyword", [
...
def test_ai_analyzer_mocked(data, expected_keyword):
    ...
    with patch.object(analyzer, "analyze_telemetry", return_value=f"[Mocked AI Analysis] {expected_keyword} link OK") as mock_ai:
